  ...
  do
    ...
    do
      ...
      do
        ...
        do
          sh post.sh "{\"constrained\": true, \"costInPoints\": 100, \"filename\": \"foo\", \"frames\": 1, \"itemCategoryId\": $CAT_ID, \"name\": \"$J $K\", \"quantityAvailable\": 100, \"variations\": 1}" https://api.parse.com/1/classes/FunItem
        done
      done
    done
  done
